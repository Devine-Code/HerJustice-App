...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('app.courtHouse', {
      url: '/courtHouse',
      views: {
        'menuContent': {
          templateUrl: 'templates/courtHouse.html'
        }
      }
    })
  .state('app.faq', {
    ...
    .state('app.stipLanguage', {
      url: '/stipLanguage',
      views: {
        'menuContent': {
          templateUrl: 'templates/stipLanguage.html'
        }
      }
    })
  .state('app.substantiveLaw', {
      url: '/substantiveLaw',
      views: {
        'menuContent': {
          templateUrl: 'templates/substantiveLaw.html'
        }
      }
    })
    .state('app.home', {
